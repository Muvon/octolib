...
//!
//! PRICING UPDATE: May 2026 (verified May 03, 2026)
...
// Model pricing (per 1M tokens in USD) - Updated May 2026 (verified against official docs)
...
const PRICING: &[PricingTuple] = &[
    // Kimi K2.6 (multimodal, latest flagship)
